## 2026-07-21 00:00 — Single-line adaptive node headlines
...
## 2026-07-21 00:00 — Clear knowledge while preserving the base taxonomy
...
## 2026-07-21 00:00 — Explicit ownership rules for agent-defined terms
...
## 2026-07-21 00:00 — One explanation, known-only content
...
Older export formats are intentionally unsupported.

## 2026-07-21 00:00 — Unified explanation and path terms
...
## 2026-07-20 00:00 — Collapsible tree and visible term glossary
...
## 2026-07-20 00:00 — Structured node descriptions and inline terms
...
The structured description model was superseded by the single known-node explanation model.

## 2026-07-17 00:00 — Epistome project rename
...
## 2026-07-17 00:00 — Versioned full export and import
...
## 2026-07-17 00:00 — Initial broad knowledge taxonomy
...
## 2026-07-17 00:00 — Subject frontier listing API
...
## 2026-07-17 00:00 — Agent discovery and API specification
...
## 2026-07-17 00:00 — Stateless AI agent API
...
## 2026-07-17 00:00 — Initial base system
...
## 2026-07-24 16:07 — Structural and design code audit
...
Audited the domain, SQLite schema and migrations, HTTP boundary, browser client, agent discovery contract, documentation, and tests. Confirmed three concrete edge cases outside the current suite: split UTF-8 request chunks can corrupt stored text; JavaScript and SQLite use inconsistent Unicode case normalization for sibling uniqueness, allowing a database that its own import validator rejects; and browser PATCH accepts malformed or empty objects, producing a 500 for null and advancing revisions for no-op updates. Identified follow-on design improvements around shared command validation, one canonical sibling key, buffered request decoding, shared agent contract metadata, versioned migrations, and splitting pure transfer validation from the KnowledgeBase facade.

### Limitations

No implementation code was changed. npm run check passes all 40 tests. The audited local main checkout is five commits behind origin/main and already had unrelated Projector-managed file changes; those were preserved. The three concrete defect patterns were spot-checked and still exist on origin/main.
